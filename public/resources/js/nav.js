...
function colorRed() {
    ...
    for(let i = 0; i < document.querySelectorAll(".resp_menu__link--active:link path").length; i++){
        document.querySelectorAll(".resp_menu__link--active:link path")[i].setAttribute("fill", "#F66C0E");
        if (document.querySelectorAll(".resp_menu__link--active:link polygon").length > 0){
            document.querySelectorAll(".resp_menu__link--active:link polygon")[i].setAttribute("fill", "#F66C0E");
        }
