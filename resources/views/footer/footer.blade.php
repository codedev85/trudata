  ...
  <br><br>
            <div class="main-content__container">
                ...
                <div class="main-content__inner_wrapper">
                    ...
                    <form id="form-submit" method="post" action="{{url('/update-footer/'.$findFooter->id)}}" enctype="multipart/form-data">
                        @csrf
                    <div class="main__container">
                    
                        <div class="center__container">
                            <div class="center__container--wrapper center__container--second-wrapper">
                             <textarea placeholder="text" name="trudata"> {{$findFooter->trudata}}</textarea>
                              <input name="welcome" value="{{$findFooter->welcome}}">
                              <input name="company_addres" value="{{$findFooter->coy_address}}">
                            </div>
                            ...
                            <div class="form__container--section-vision">
                                ...
                                $company = json_decode($findFooter->company);
                                // dd($company);
                                // dd($benefit);
                            ...
                            <div class="vision_switchable--container v--switchable-container--on">
                                ...
                                <textarea placeholder="text" name="company[]"> {{$company[0]}}</textarea>
                            </div>
                            <div class="vision_switchable--container ">
                                <textarea placeholder="text" name="company[]"> {{$company[1]}}</textarea>
                             </div>
                             <div class="vision_switchable--container ">
                                <textarea placeholder="text" name="company[]"> {{$company[2]}}</textarea>
                             </div>
                             <div class="vision_switchable--container ">
                                <textarea placeholder="text" name="company[]"> {{$company[3]}}</textarea>
                             </div>
                             <div class="vision_switchable--container ">
                                    <textarea placeholder="text" name="company[]"> {{$company[4]}}</textarea>
                                 </div>
                                ...
                                <div>
                                    <div class="white__small--btn-wrapper">
                                        ...
                                        <button class="white__small--btn v-js-btn"><span>5</span></button>
                                    </div>
                                </div>
                            </div>
                       ...
                       <div class="form__container--section-vision">
                        ...
                        <?php
                         ...
                         $product = json_decode($findFooter->product);
                       //  dd($product);
                        ...
                        <div class="values--switchable--container values--switchable-container--on">
                                    ...
                                    <textarea placeholder="text" name="product[]">{{$product[0]}}</textarea>
                        </div>
                        <div class="values--switchable--container ">
                                  <textarea placeholder="text" name="product[]">{{$product[1]}}</textarea>
                        </div>
                        <div class="values--switchable--container ">
                                <textarea placeholder="text" name="product[]">{{$product[2]}}</textarea>
                      </div>
                            <div>
                                <div class="white__small--btn-wrapper">
                                    ...
                                    <button class="white__small--btn values--js-btn"><span>1</span></button> 
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form__container--section-vision">
                            ...
                            <?php
                             ...
                             $legal = json_decode($findFooter->legal);
                          
                            // $mission_desc  = json_decode($about->mission_desc);
    
                                ?>
                            <div class="legal--switchable--container legal--switchable-container--on">
                                        {{-- <input type="file" name="service_img"/> --}}
                                        <textarea placeholder="text" name="legal[]">{{$legal[0]}}</textarea>
                            </div>
                            <div class="legal--switchable--container ">
                                      <textarea placeholder="text" name="legal[]">{{$legal[1]}}</textarea>
                            </div>
                            <div class="legal--switchable--container ">
                                    <textarea placeholder="text" name="legal[]">{{$legal[2]}}</textarea>
                          </div>
                                <div>
                                    <div class="white__small--btn-wrapper">
                                        <button class="white__small--btn legal--js-btn"><span>1</span></button> <button class="white__small--btn legal--js-btn"><span>2</span></button> 
                                        <button class="white__small--btn legal--js-btn"><span>1</span></button> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="center__container">
                                ...
                                <div class="center__container--wrapper center__container--second-wrapper">
                                  ...
                                  <input name="connect_email" value="{{$findFooter->connectEmail}}">
                                  <input name="connect_address" value="{{$findFooter->connectAddress}}">
                        </div>

                        <div class="center__container">
                          
                                <div class="center__container--wrapper center__container--second-wrapper copyright">
                                        <h3>Copyright</h3>
                                        <textarea placeholder="text" name="copyright">{{$findFooter->copyright}}</textarea>
...
let LegalswitchBtns = document.querySelectorAll(".legal--js-btn");
        let LegalswitchableContainers = document.querySelectorAll(".legal--switchable--container");
        for (let i = 0; i < LegalswitchBtns.length; i++) {
            LegalswitchBtns[i].addEventListener('click', function(e) {
                e.preventDefault();
                LegalswitchableContainers.forEach(function(item) {
                    item.classList.remove('legal--switchable-container--on');
                });
                LegalswitchBtns.forEach(function(item) {
                    item.classList.remove('active');
                });
               LegalswitchableContainers[i].classList.add('legal--switchable-container--on');
                LegalswitchBtns[i].classList.add('active')
            })
        }
        //jquery  to subbmifom
