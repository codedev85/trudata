            ...
            <div class="main-content__container">
                ...
                <div class="main-content__inner_wrapper">
                        <div class="form__header--list1">
                                <p class="">
                                    <img src="../resource/images/left-arrow.svg" alt="" class="back__arrow"><span class=""><a href="{{ url('/roles') }}">Back</a></span>
                                </p>
                             
                            </div>
                    <form id="form-submit" method="post" action="{{url('/update-role/'.$findRole->id)}}" enctype="multipart/form-data">
                        @csrf
                    <div class="main__container">
                        ...
                        <div class="center__container--wrapper center__container--third-wrapper role-wrapper">
                            <h3>Edit New Role</h3>
                            <br>
                        <input  class="input" placeholder="Role" name="role" value="{{$findRole->name}}">
                           </div>
