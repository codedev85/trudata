  ...
  <br><br>
            <div class="main-content__container">
                ...
                <div class="main-content__inner_wrapper">
                    ...
                    <form id="form-submit" method="post" action="{{url('/update-social/'.$social->id)}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="center__container">
                            ...
                            <div class="form__container--section">
                                ...
                                <?php
                                 ...
                                 $socialMedia = json_decode($social->name);
                              
                               
                                ?>
                            <div class="vision_switchable--container v--switchable-container--on">
                                <input placeholder="facebook" name="social[]" value="{{$socialMedia[0]}}">
                            </div>
                            <div class="vision_switchable--container ">
                                <input placeholder="instagram" name="social[]" value="{{$socialMedia[1]}}">
                             </div>
                             <div class="vision_switchable--container ">
                                <input placeholder="linkedin" name="social[]" value="{{$socialMedia[2]}}">
                             </div>
                             <div class="vision_switchable--container ">
                                <input placeholder="twitter" name="social[]" value="{{$socialMedia[3]}}">
                             </div>

                             <div class="vision_switchable--container ">
                                    <input placeholder="youtube" name="social[]" value="{{$socialMedia[4]}}">
                                 </div>
                                <div>
                                    <div class="white__small--btn-wrapper">
                                         <button class="white__small--btn  v-js-btn"><span> <img src="resource/images/facebook_white.svg" alt="" width="15px"></span></button>
                                         <button class="white__small--btn v-js-btn"><span> <img src="resource/images/insta_white.svg" alt="" width="15px"></span></button> 
                                         <button class="white__small--btn v-js-btn"><span> <img src="resource/images/linked_white.svg" alt="" width="15px"></span></button>
                                         <button class="white__small--btn v-js-btn"><span><img src="resource/images/twitter_white.svg" alt="" width="15px"></span></button> 
                                         <button class="white__small--btn v-js-btn"><span><img src="resource/images/youtube_white.svg" alt="" width="15px"></span></button>
                                    </div>
                                </div>
                            </div>
