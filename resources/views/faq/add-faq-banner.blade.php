  ...
  <br><br>
            <div class="main-content__container">
                ...
                <div class="main-content__inner_wrapper">
                    ...
                    <form id="form-submit" method="post" action="{{url('/update-faq-banner/'.$faqbanner->id)}}" enctype="multipart/form-data">
                        @csrf
                    <div class="main__container">
                        ...
                        <div class="center__container--wrapper center__container--third-wrapper faq-wrapper" style="display:flex; align-items:center;justify-content:center;">
                            ...
                            <input type="text" name="header_two" value="{{$faqbanner->header_two}}"/>
                                <input  type="file" class="input"  name="faq_banner" value="">
                                <span class="dimension">Width:1920px - height:466px</span>
                               <img src="{{url('storage/'.$faqbanner->hero_bg)}}" width="500px" height="150px" />
