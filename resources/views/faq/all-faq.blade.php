        ...
        <div class="main-content">
            ...
            <div class="main-content__container">
                ...
                <div class="manage-account">
                    ...
                    <div class="manage-account__tool-bar">
                        ...
                        <a href="{{url('/add-faq-banner/')}}" class="btn manage-account__btn btn--create btn--medium">
                            <img src="../assets/images/plus_.svg" alt="">
                            &nbsp;&nbsp;Create Faq Banner
                        </a>
                        <a href="{{url('/add-new-faq/')}}" class="btn manage-account__btn btn--create btn--medium">
                            <img src="../assets/images/plus_.svg" alt="">
                            &nbsp;&nbsp;Create New Faq
                        </a>
            ...
            @foreach($faqs as $faq)
                               <div class="manage-account_user-list-item">
                                    ...
                                    &nbsp;&nbsp;&nbsp; <a href="{{url('/edit-faq/'.$faq->id)}}" class="btn btn--danger">
                                            EDIT
                                        </a>
                                        @if($faq->status == 0)
                                        &nbsp;&nbsp;&nbsp; <a href="{{url('/publish/'.$faq->id)}}" class="btn btn--danger">
                                            PUBLISH
                                        </a>
                                        @else
                                        &nbsp;&nbsp;&nbsp; <a href="{{url('/unpublish/'.$faq->id)}}" class="btn btn--default">
                                           UNPUBLISH
                                        </a>
                                        @endif
                                    </p>
