  ...
  <br><br>
            <div class="main-content__container">
                ...
                <div class="main-content__inner_wrapper">
                    ...
                    <form id="form-submit" method="post" action="{{url('/update-faq/'.$findFaq->id)}}" enctype="multipart/form-data">
                        @csrf
                    <div class="main__container">
                        ...
                        <div class="center__container--wrapper center__container--third-wrapper faq-wrapper">
                            <h3>Edit New Faq</h3>
                            <br>
                                <input  class="input" placeholder="Faq Title" name="title" value="{{$findFaq->title}}">
                                <textarea name="faq_desc">{{$findFaq->desc}}</textarea>
