    ...
    <div class="main__section">
        ...
        <div class="side-navigation">
            ...
            <div class="side-navigation__link_container">
                ...
                {{-- <div class="side-navigation__inner_link_container">
                        <a href="{{ url('/leadership/') }}" class="side-navigation__link">
                            <svg width="21" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0)">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M17.0415 3.5722H3.00724C3.00724 3.5722 1.94403 3.40412 1.94403 2.89987L17.2541 1.72328V0.714782C17.2541 0.714782 17.0655 -0.205645 15.3404 0.0424469L1.73139 1.89137C1.73139 1.89137 0.0302734 2.05945 0.0302734 3.74029V13.3211C0.0302734 14.2492 0.982263 15.0019 2.15667 15.0019H17.0415C18.2159 15.0019 19.1679 14.2492 19.1679 13.3211V5.25304C19.1679 4.32488 18.2159 3.5722 17.0415 3.5722ZM15.7656 10.4636C14.9436 10.4636 14.2772 9.93686 14.2772 9.28705C14.2772 8.63724 14.9436 8.11046 15.7656 8.11046C16.5877 8.11046 17.2541 8.63724 17.2541 9.28705C17.2541 9.93686 16.5877 10.4636 15.7656 10.4636Z"
  ...
  <br><br>
            <div class="main-content__container">
                    ...
                    <div class="manage-account__tool-bar">
                            ...
                            <a href="{{url('/add-terms-banner/')}}" class="btn  btn--medium">
                                <img src="../assets/images/plus_.svg" alt="">
                                &nbsp;&nbsp;Create Terms Of Use Background
                            </a>
                ...
                <div class="main-content__inner_wrapper">
                    ...
                    <form id="form-submit" method="post" action="{{url('/post-update-term/'.$findTerm->id)}}" enctype="multipart/form-data">
                        @csrf
                    <div class="main__container">
                        <div class="center__container">
                            <div class="center__container--wrapper center__container--second-wrapper">
                               <input  class="input" placeholder="title" name="policy_title" value="{{$findTerm->policy_date}}">
                               <textarea class="text-area-desc" name="policy_desc">{{$findTerm->policy}}</textarea>
                                {{-- <input type="text" name="hero_bg_small" value=""> --}}
                            ...
                            <div class="form__container--section-vision">
                               ...
                               $siteUsage = json_decode($findTerm->site_usage);
                                // $mission_desc  = json_decode($about->mission_desc);

                                ?>
                            <div class="vision_switchable--container v--switchable-container--on">
                                <br>
                                 {{-- <input type="text" name="usage_title[]" value=""/> --}}
                                <textarea placeholder="text" name="site_usage[]">{{$siteUsage[0]}}</textarea>
                            </div>
                            <div class="vision_switchable--container ">
                                <br>
                                    {{-- <input type="text" name="usage_title[]" value=""/> --}}
                                <textarea placeholder="text" name="site_usage[]">{{$siteUsage[1]}}</textarea>
                             </div>
                             <div class="vision_switchable--container ">
                                    <br>
                                        {{-- <input type="text" name="usage_title[]" value=""/> --}}
                                    <textarea placeholder="text" name="site_usage[]">{{$siteUsage[2]}}</textarea>
                                 </div>
                                 <div class="vision_switchable--container ">
                                        <br>
                                            {{-- <input type="text" name="usage_title[]" value=""/> --}}
                                        <textarea placeholder="text" name="site_usage[]">{{$siteUsage[3]}}</textarea>
                                     </div>
                                     <div class="vision_switchable--container ">
                                            <br>
                                                {{-- <input type="text" name="usage_title[]" value=""/> --}}
                                            <textarea placeholder="text" name="site_usage[]">{{$siteUsage[4]}}</textarea>
                                         </div>
                                 <div class="vision_switchable--container ">
                                        <br>
                                            {{-- <input type="text" name="usage_title[]" value=""/> --}}
                                        <textarea placeholder="text" name="site_usage[]">{{$siteUsage[5]}}</textarea>
                                     </div>
                            ...
                            $privacy            = json_decode($findTerm->privacy_desc);
                            $privacyPolicyTitle = json_decode($findTerm->privacy_policy_title);
                            $privacyTitle       = json_decode($findTerm->privacy_title);

                             ?>

                            <div class="center__container--wrapper center__container--second-wrapper">
                                <h3>Main Privacy Policy</h3>
                                    <textarea class="text-area-desc" name="privacy_policy">{{$findTerm->privacy_desc}}</textarea>
                           </div>
                            {{-- <div class="form__container--section-vision">
                                <h3>Join Our Team</h3>
                                <br>
                                 <input type="text" name="team_header" value=""/>
                                <textarea placeholder="text" name="team_desc"></textarea>
                          </div> --}}
                          ...
                          <div class="form__container--section-vision">
                                ...
                                // $mission_header = json_decode($about->mission);
                                // $mission_desc  = json_decode($about->mission_desc);

                                ?>
                            <div class="privacy_switchable-container privacy_switchable-container--on">
                                <br>
                                 <input type="text" name="privacy_title[]" value="{{$privacyTitle[0]}}"/>
                                <textarea placeholder="text" name="privacy_desc[]">{{$privacyPolicyTitle[0]}}</textarea>
                            </div>
                            <div class="privacy_switchable-container ">
                                <br>
                                 
                                <textarea placeholder="text" name="privacy_desc[]">{{$privacyPolicyTitle[1]}}</textarea>
                             </div>
                             <div class="privacy_switchable-container ">
                                    <br>
                                     
                                    <textarea placeholder="text" name="privacy_desc[]">{{$privacyPolicyTitle[2]}}</textarea>
                                 </div>
                                 <div class="privacy_switchable-container ">
                                        <br>
                                          
                                        <textarea placeholder="text" name="privacy_desc[]">{{$privacyPolicyTitle[3]}}</textarea>
                                     </div>
                                    
                     
                                <div>
                                    <div class="white__small--btn-wrapper">
                                        <button class="white__small--btn p-js-btn"><span>1</span></button> <button class="white__small--btn p-js-btn"><span>2</span></button> 
                                        <button class="white__small--btn p-js-btn"><span>3</span></button><button class="white__small--btn p-js-btn"><span>4</span></button>
                                        {{-- <button class="white__small--btn v-js-btn"><span>5</span></button><button class="white__small--btn v-js-btn"><span>6</span></button> --}}
                                    </div>
                                </div>
                     </div>
                     <div class="center__container--wrapper center__container--second-wrapper">
                            <h3>Cookies  Policy</h3>
                                <textarea class="main_cookie_desc" name="cookies_policy">{{$findTerm->cookies}}</textarea>
                       </div>
                     <div class="form__container--section-vision">
                            <h3>Cookies Policy</h3>
                            <?php
                           
                            $cookies_title = json_decode($findTerm->cookies_title);
                            $cookies_desc  = json_decode($findTerm->cookies_policies);

                            ?>
                        <div class="cookies_switchable-container cookies_switchable-container--on">
                            <br>
                             <input type="text" name="cookies_title[]" value="{{$cookies_title[0]}}"/>
                            <textarea placeholder="text" name="cookies_desc[]">{{$cookies_desc[0]}}</textarea>
                        </div>
                        <div class="cookies_switchable-container ">
                            <br>
                             
                            <textarea placeholder="text" name="cookies_desc[]">{{$cookies_desc[1]}}</textarea>
                         </div>
                         {{-- <div class="cookies_switchable-container ">
                                <br>
                                 
                                <textarea placeholder="text" name="cookies_desc[]">{{$cookies_desc[2]}}</textarea>
                             </div>
                             <div class="cookies_switchable-container ">
                                    <br>
                                      
                                    <textarea placeholder="text" name="cookies_desc[]">{{$cookies_desc[3]}}</textarea>
                                 </div> --}}
                                
                 
                            <div>
                                <div class="white__small--btn-wrapper">
                                    <button class="white__small--btn c-js-btn"><span>1</span></button> <button class="white__small--btn c-js-btn"><span>2</span></button> 
                                    {{-- <button class="white__small--btn c-js-btn"><span>3</span></button><button class="white__small--btn c-js-btn"><span>4</span></button> --}}
                                    {{-- <button class="white__small--btn v-js-btn"><span>5</span></button><button class="white__small--btn v-js-btn"><span>6</span></button> --}}
                                </div>
                            </div>
                 </div>
                 ...
                 <div class="center__container--wrapper center__container--second-wrapper">
                        <h3>Security  Policy</h3>
                            <textarea class="text-area-desc" name="security_policy">{{$findTerm->security}}</textarea>
                   </div>
                   <div class="form__container--section-vision">
                        <h3>Security Policy</h3>
                        <?php
                       
                        $securityTitle = json_decode($findTerm->security_title);
                        $securityDesc = json_decode($findTerm->security_desc);

                        ?>
                    <div class="security_switchable-container security_switchable-container--on">
                        <br>
                         <input type="text" name="security_policy_title[]" value="{{$securityTitle[0]}}"/>
                        <textarea placeholder="text" name="security_policy_desc[]">{{$securityDesc[0]}}</textarea>
                    </div>
                    {{-- <div class="security_switchable-container ">
                        <br>
                         
                        <textarea placeholder="text" name="why_tru_data[]"></textarea>
                     </div>
                     <div class="security_switchable-container ">
                            <br>
                        ...
                        <div>
                            <div class="white__small--btn-wrapper">
                                <button class="white__small--btn s-js-btn"><span>1</span></button> 
                                {{-- <button class="white__small--btn s-js-btn"><span>2</span></button>  --}}
                                {{-- <button class="white__small--btn s-js-btn"><span>3</span></button><button class="white__small--btn s-js-btn"><span>4</span></button> --}}
                                {{-- <button class="white__small--btn v-js-btn"><span>5</span></button><button class="white__small--btn v-js-btn"><span>6</span></button> --}}
                            </div>
                        </div>
             </div>
    ...
    <script>
        ...
        //privacy policy
        let privacyswitchBtns = document.querySelectorAll(".p-js-btn ");
        let privacyswitchableContainers = document.querySelectorAll(".privacy_switchable-container");
        for (let i = 0; i < privacyswitchBtns.length; i++) {
            privacyswitchBtns[i].addEventListener('click', function(e) {
                e.preventDefault();
                privacyswitchableContainers.forEach(function(item) {
                    item.classList.remove('privacy_switchable-container--on');
                });
                privacyswitchBtns.forEach(function(item) {
                    item.classList.remove('active');
                });
                privacyswitchableContainers[i].classList.add('privacy_switchable-container--on');
                privacyswitchBtns[i].classList.add('active')
            })
        }


          //cookies policy
          let cookiesswitchBtns = document.querySelectorAll(".c-js-btn ");
        let cookiesswitchableContainers = document.querySelectorAll(".cookies_switchable-container");
        for (let i = 0; i < cookiesswitchBtns.length; i++) {
            cookiesswitchBtns[i].addEventListener('click', function(e) {
                e.preventDefault();
                cookiesswitchableContainers.forEach(function(item) {
                    item.classList.remove('cookies_switchable-container--on');
                });
                cookiesswitchBtns.forEach(function(item) {
                    item.classList.remove('active');
                });
                cookiesswitchableContainers[i].classList.add('cookies_switchable-container--on');
                cookiesswitchBtns[i].classList.add('active')
            })
        }
     

                  //security policy
                  let securityswitchBtns = document.querySelectorAll(".s-js-btn ");
        let securityswitchableContainers = document.querySelectorAll(".security_switchable-container");
        for (let i = 0; i < securityswitchBtns.length; i++) {
            securityswitchBtns[i].addEventListener('click', function(e) {
                e.preventDefault();
                securityswitchableContainers.forEach(function(item) {
                    item.classList.remove('security_switchable-container--on');
                });
                securityswitchBtns.forEach(function(item) {
                    item.classList.remove('active');
                });
                securityswitchableContainers[i].classList.add('security_switchable-container--on');
                securityswitchBtns[i].classList.add('active')
            })
        }
