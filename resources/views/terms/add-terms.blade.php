  ...
  <br><br>
            <div class="main-content__container">
                ...
                <div class="main-content__inner_wrapper">
                    ...
                    <form id="form-submit" method="post" action="{{url('/post-terms/')}}" enctype="multipart/form-data">
                        @csrf
                    <div class="main__container">
                        <div class="center__container">
                            <div class="center__container--wrapper center__container--second-wrapper">
                               <input  class="input" placeholder="title" name="policy_title" value="">
                               <textarea class="text-area-desc" name="policy_desc"></textarea>
                            ...
                            <div class="vision_switchable--container v--switchable-container--on">
                                ...
                                <textarea placeholder="text" name="site_usage[]"></textarea>
                            </div>
                            ...
                            <div class="center__container--wrapper center__container--second-wrapper">
                                <h3>Privacy Policy</h3>
                                    <textarea class="text-area-desc" name="privacy_policy"></textarea>
                           </div>
                            {{-- <div class="form__container--section-vision">
                                <h3>Join Our Team</h3>
                                <br>
                          ...
                          <div class="form__container--section-vision">
                            ...
                            <div class="privacy_switchable-container privacy_switchable-container--on">
                                <br>
                                 <input type="text" name="privacy_title[]" value=""/>
                                <textarea placeholder="text" name="privacy_desc[]"></textarea>
                            </div>
                     ...
                     <div class="center__container--wrapper center__container--second-wrapper">
                            <h3>Cookies  Policy</h3>
                                <textarea class="main_cookie_desc" name="cookies_policy"></textarea>
                       </div>
                     <div class="form__container--section-vision">
                            <h3>Cookies Policy</h3>
                            <?php
                        ...
                        <div class="cookies_switchable-container cookies_switchable-container--on">
                            <br>
                             <input type="text" name="cookies_title[]" value=""/>
                            <textarea placeholder="text" name="cookies_desc[]"></textarea>
                        </div>
                 ...
                 <div class="center__container--wrapper center__container--second-wrapper">
                        <h3>Security  Policy</h3>
                            <textarea class="text-area-desc" name="security_policy"></textarea>
                   </div>
                   <div class="form__container--section-vision">
                        <h3>Security Policy</h3>
                        <?php
                    ...
                    <div class="security_switchable-container security_switchable-container--on">
                        <br>
                         <input type="text" name="security_policy_title[]" value=""/>
                        <textarea placeholder="text" name="security_policy_desc[]"></textarea>
                    </div>
