                ...
                <div class="main-content__inner_wrapper">
                    ...
                    <div class="main__container"> 
                        ...
                        <div class="center__container--wrapper center__container--third-wrapper">
                            <h3>Edit Blog</h3>
                            <br>
                                <input  class="input" placeholder="title" name="title" value="{{$findBlog->title}}">
                                <select name="category" >
                                    <option value="{{$findBlog->category['id']}}">{{$findBlog->category['name']}}</option>
                                ...
                                <textarea class="text-area" name="blog_main">{{$findBlog->content}}</textarea>
