                ...
                <div class="manage-account">
                    ...
                    <div class="manage-account__tool-bar">
                        @if(Auth::user()->role_id < 3)
                            <a href="{{url('/send-mail-to-all-admin/')}}" class="btn manage-account__btn btn--create btn--medium btn--approve">
                                {{-- <img src="../assets/images/plus_.svg" alt=""> --}}
                                &nbsp;&nbsp;Send Mail To All Admin
                            </a>
                            <a href="{{url('/add-admin/')}}" class="btn manage-account__btn btn--create btn--medium">
                                <img src="../assets/images/plus_.svg" alt="">
                                &nbsp;&nbsp;Create Admin
                            </a>
                       @endif
                               ...
                               <div class="manage-account_user-list-item">
                                    ...
                                    @if(Auth::user()->role_id < 3) 
                                        <a href="{{url('/edit-admin/'.$admin->id)}}" class="btn btn--danger reset-password">
                                                ...
                                                @if($admin->status == 1)
                                                &nbsp;&nbsp;&nbsp; <a href="{{url('/suspend/admin/'.$admin->id)}}" class="btn btn--suspend">
                                                    SUSPEND
                                                    {{-- <img src="../assets/images/delete.svg" alt=""> --}}
                                                </a>
                                                @else
                                                &nbsp;&nbsp;&nbsp; <a href="{{url('/approve/admin/'.$admin->id)}}" class="btn btn--approve">
                                                    APPROVE
                                                        {{-- <img src="../assets/images/delete.svg" alt=""> --}}
                                                    </a>
                                                @endif
