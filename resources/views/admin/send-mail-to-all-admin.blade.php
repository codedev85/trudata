  ...
  <br><br>
            <div class="main-content__container">
                ...
                <div class="main-content__inner_wrapper">
                    ...
                    <form id="form-submit" method="post" action="{{url('/post-mail-to-all-admin/')}}" enctype="multipart/form-data">
                        @csrf
                    <div class="main__container">
                        <div class="center__container">
                                ...
                                foreach($admins as $admin){
                                    ...
                                    $emailArrays = array_push($mail, $adminEmail);
                                }
                        ...
                        <div class="center__container--wrapper center__container--third-wrapper">
                            <h3>Send Mail To All Admin </h3>
                            <br>
                                <input  class="input" placeholder="fullname" name="email" value="{{json_encode($mail)}}" >
