                                    ...
                                    <div class="row contact__form-map">
                                        ...
                                        <div class="map__container map__container--contact">
                                            <div class="mapouter">
                                                <div class="gmap_canvas"><iframe width="100%" height="100%" id="gmap_canvas"
                                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.264864289349!2d3.3796512147063336!3d6.48810632537397!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b93e074460ff7%3A0x127ae19b36a7f72f!2sKJK.Africa%20(KJK)!5e0!3m2!1sen!2sng!4v1574850154789!5m2!1sen!2sng"
                                        ...
                                        <div class="contact__form_container">
                                            ...
                                            <p class="contact__form_sub">
                                                Still have Questions? Mail Us using the Form below.
                                            </p>
                            
                                            <form action="{{url('/sendmail-to-kjk/')}}" method="post" class="contact__form">
                                    ...
                                    <div class="contact__details">
                                        ...
                                        <div class="contact__details_container row">
                                            ...
                                            <div class="contact__details_info">
                                                ...
                                                <div>
                                                    <div class="contact__details_item">
                                                     ...
                                                     Block 36, Apartment, 6 Glover Estate, Adekunle, Yaba, Lagos                         
                                                     </p>
                                                    </div>
                                                    <div class="contact__details_item">
                                                        <img src="resources/images/location__pink.svg" alt="">
                                            ...
                                            <div class="social__details_container">
                                                ...
                                                <a href=""  target="_blank" class="footer__social_link_img">
                                                    <img src="resources/images/facebook__footer.svg" alt="" class="footer__social_img">
                                                </a>
                                                <a href="https://www.twitter.com/kjkafrica"  target="_blank" class="footer__social_link_img">
                                                    <img src="resources/images/twitter_footer.svg" alt="" class="footer__social_img">
                                                </a>
                                                <a href="https://www.instagram.com/kjkafrica"  target="_blank" class="footer__social_link_img">
