            ...
            <div class="contact__form_container">
                ...
                <form action="" class="contact__form">
                    ...
                    <div class="contact__input_container">
                        ...
                        <input type="text" name="" placeholder="First Name" class="contact__form_input">
                    </div>

                    <div class="contact__input_container">
                        <img src="resources/images/user__white.svg" alt="">
                        <input type="text" name="" placeholder="Last Name" class="contact__form_input">
                    </div>

                    <div class="contact__input_container">
                        <img src="resources/images/env__white.svg" alt="">
                        <input type="email" name="" placeholder="Email" class="contact__form_input">
                    </div>

                    <textarea name="" class="contact__form_input contact__form_input--textarea"
