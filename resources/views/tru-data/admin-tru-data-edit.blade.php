  ...
  <br><br>
            <div class="main-content__container">
                ...
                <div class="main-content__inner_wrapper">
                    ...
                    <form id="form-submit" method="post" action="{{url('/admin-why-us-page-edit/')}}" enctype="multipart/form-data">
                        @csrf
                    <div class="main__container">
                        <div class="center__container">
                            <div class="center__container--wrapper center__container--second-wrapper">
                            <input  class="input" placeholder="title" name="hero-bg-text" value="">
                                <input type="text" name="hero_bg_small">
                            ...
                            <div class="center__container--wrapper center__container--second-wrapper">
                                    <h3>Verify Background Image</h3>
                                        ...
                                        <div class="container custom__edit--img-inner"><span class="span__text--container">Width - 1920px Height - 518px</span> <img src="../resource/images/featuredimg__tworeport.jpg"></div>
                                    </div>
                        ...
                        <div class="center__container--wrapper center__container--second-wrapper">
                                <h3>Why Tru Data Image</h3>
                                    ...
                                    <div class="container custom__edit--img-inner"><span class="span__text--container">Width - 806px Height - 665px</span> <img src="../resource/images/featuredimg__tworeport.jpg"></div>
                                </div>
                        <div class="form__container--section">
                            <h3>Map</h3>
                            <?php
                        ...
                        <div class="map_switchable--container map--switchable-container--on">
                            <input class="input"  placeholder="Embeded Url" name="embeded" value="">
                        ...
                        <div class="center__container--wrapper center__container--third-wrapper">
                            <h3>Contact Us</h3>
                                <input  class="input" placeholder="+234" name="contact_number" value="">
