  ...
  <br><br>
            <div class="main-content__container">
                ...
                <div class="main-content__inner_wrapper">
                    ...
                    <form id="form-submit" method="post" action="{{url('/admin-why-us-page-edit/'.$whyUs->id)}}" enctype="multipart/form-data">
                        @csrf
                    <div class="main__container">
                        <div class="center__container">
                            <div class="center__container--wrapper center__container--second-wrapper">
                            <input  class="input" placeholder="title" name="hero-bg-text" value="{{$whyUs->hero_bg_text}}">
                                <input type="text" name="hero_bg_small" value="{{$whyUs->hero_bg_small}}">
                                <input type="file" name="hero_bg">
                                <div class="container custom__edit--img-inner"><span class="span__text--container dimension">Width - 1919px Height - 494px</span> 
                                <img src="{{url('storage/'.$whyUs->hero_bg_img)}}" height="100">
                                </div>
                            </div>
                            <div class="form__container--section">
                                <h3>Why Tru Data</h3>
                                <?php
                                $desc = json_decode($whyUs->why_us);
                               
                                ?>
                            <div class="vision_switchable--container v--switchable-container--on">
                                <textarea placeholder="text" name="why_tru_data[]">{{$desc[0]}}</textarea>
                            </div>
                            <div class="vision_switchable--container ">
                                <textarea placeholder="text" name="why_tru_data[]">{{$desc[1]}}</textarea>
                             </div>
                             <div class="vision_switchable--container ">
                                <textarea placeholder="text" name="why_tru_data[]">{{$desc[2]}}</textarea>
                             </div>
                             <div class="vision_switchable--container ">
                                <textarea placeholder="text" name="why_tru_data[]">{{$desc[3]}}</textarea>
                             </div>
                                <div>
                                    <div class="white__small--btn-wrapper">
                                        <button class="white__small--btn v-js-btn"><span>1</span></button> <button class="white__small--btn v-js-btn"><span>2</span></button> <button class="white__small--btn v-js-btn"><span>3</span></button><button class="white__small--btn v-js-btn"><span>4</span></button>
                                    </div>
                                </div>
                            </div>
                         
                            <div class="center__container--wrapper center__container--second-wrapper">
                                    <h3>Verify Background Image</h3>
                    
                                        <input type="file" name="verify_hero_bg">
                                        <div class="container custom__edit--img-inner"><span class="span__text--container dimension">Width - 1920px Height - 518px</span> 
                                            <img src="{{url('storage/'.$whyUs->verify_img)}}"></div>
                                    </div>

                        <div class="center__container--wrapper center__container--second-wrapper">
                                <h3>Why Tru Data Image</h3>
                
                                    <input type="file" name="why_tru_data_hero_bg">
                                    <div class="container custom__edit--img-inner"><span class="span__text--container dimension">Width - 806px Height - 665px</span>
                                         <img src="{{url('storage/'.$whyUs->why_us_img)}}" height="150"></div>
                                </div>
                        <div class="form__container--section">
                            <h3>Map</h3>
                            <?php
                        ...
                        <input class="input"  placeholder="Embeded Url" name="embeded" value="{{$whyUs->embed_url}}">
                            {{-- <textarea placeholder="text" name="vision_desc[]"></textarea> --}}

                            {{-- <div class="container custom__edit--img-inner"><span class="span__text--container dimension">Width - 1840px Height - 1236px</span> 
                            <iframe src="https://www.google.com/maps/embed?pb=!1m24!1m12!1m3!1d3964.2049453678983!2d3.37779986470635!3d6.495716825287998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m9!3e6!4m3!3m2!1d6.4960415!2d3.3801172999999998!4m3!3m2!1d6.4952736!2d3.3802887999999998!5e0!3m2!1sen!2sus!4v1569573838385!5m2!1sen!2sus" width="400" height="300" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                            </diV> --}}
                        </div>
                        ...
                        <div class="center__container--wrapper center__container--third-wrapper">
                            <h3>Contact Us</h3>
                                <input  class="input" placeholder="+234" name="contact_number" value="{{$whyUs->contact_number}}">
                                <input type="email" name="contact_email" value="{{$whyUs->contact_email}}">
                                <input type="file" name="contact_hero_bg">
                                <div class="container custom__edit--img-inner"><span class="span__text--container dimension">Width - 1840px Height - 1236px</span> 
                                    <img src="{{url('storage/'.$whyUs->contact_img)}}" height="150"></div>
                        </div>
