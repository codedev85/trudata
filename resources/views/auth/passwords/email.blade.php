...
<body>
    <div class="container">
        <div class="container__half">
            ...
            <form method="POST" class="form__container form__container--active" action="{{ route('password.email') }}">
                @csrf
                ...
                <input type="submit" class="login__input login__input--submit" value="RESET">
            </form>
